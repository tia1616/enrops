...
//
// NOTE: this is a self-contained copy of extract-curriculum-details/parse.ts.
// Copied rather than shared so this new function can't destabilize the live
// curriculum extractor. If PDF/docx parsing ever needs a fix, update both (or
// promote to _shared then). Library choices (Deno/edge-friendly, no native deps):

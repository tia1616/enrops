...
//
// NAMING: both shapes are titled "Sites". Jessica's 2026-08-05 call was one name
// for one surface — operators don't distinguish "the partner" from "the place" (a
// lean provider's partner is 1:1 with a school) and two names sent a provider
// hunting for the district field. On 2026-08-08 she set the noun: sites and
// locations are the same thing, so BOTH shapes say "site" and there is no
// venue_model conditional in the wording. The partner-first STRUCTURE below is
// unchanged; only the label is. `partners`/`partner_id` remain the schema terms,
// and "venue" (program_locations) is a SEPARATE entity — left alone deliberately.
...
export default function SchoolsLocations() {
  ...
  const title = 'Sites'; // both venue models — see NAMING note at top

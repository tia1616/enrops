...
const TEMPLATES = [
  { key: "schedule_change", icon: "📅", label: "Schedule change", subject: "Update: {{curriculum_name}} at {{school_name}} — schedule change", body: "Hi {{parent_first_name}},\n\nWe're writing to let you know about a change to {{student_first_name}}'s {{curriculum_name}} class at {{school_name}}.\n\n[What changed — new day, time, room, etc.]\n\nThe updated schedule is:\nDay: {{day_of_week}}\nTime: {{start_time}}\nInstructor: {{instructor_first_name}}\n\nIf this doesn't work for your family, just reply and we'll help figure out the best option.\n\nThank you for your patience!" },
  { key: "cancellation", icon: "✕", label: "Cancellation", subject: "{{curriculum_name}} at {{school_name}} — important update", body: "Hi {{parent_first_name}},\n\nWe're sorry to let you know that {{curriculum_name}} at {{school_name}} will not be running this term due to [reason — low enrollment / scheduling conflict / etc.].\n\n[Choose one or both:]\n- We've issued a full refund to the card on file. You should see it within 5–10 business days.\n- We'd love to get {{student_first_name}} into another class! Here are some options: [list alternatives]\n\nWe know this is disappointing. Please reply if you have any questions — we're here to help." },
  { key: "sales_promo", icon: "🏷️", label: "Sales / promo", subject: "{{school_name}} families: spots are open in {{curriculum_name}}!", body: "Hi {{parent_first_name}},\n\nWe wanted to make sure you saw this — there are still spots available in {{curriculum_name}} at {{school_name}}!\n\nWhat they'll do:\n[Paste or write a 2-3 sentence description of the class — what kids build, create, or explore]\n\nThe details:\nDay: {{day_of_week}}\nTime: {{start_time}}\nStarts: {{first_session_date}}\nInstructor: {{instructor_first_name}}\n\n[Optional: Add a promo or urgency line like \"Use code FALL10 for 10% off\" or \"Only 4 spots left!\"]\n\nRegister here: {{registration_link}}\n\nQuestions? Just reply to this email." },

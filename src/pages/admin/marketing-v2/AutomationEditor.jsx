...
const TOKENS_BY_TEMPLATE_KEY = {
  ...
  // only — assignment details, response buttons, and deadline are system-
  // generated by the edge function. Tokens = instructor's name + org identity.
  availability_survey:    ["first_name", "org_name", "sender_name"],
  assignment_offer:       ["first_name", "org_name", "sender_name"],
  sub_offer:              ["first_name", "org_name", "sender_name"],
};
